...
var videoSrc = "http://vimeo.com/12235444";

test( "canPlayType for Vimeo", function(){

  var video = new HTMLVimeoVideoElement( "#video" );
...
asyncTest( "video.duration, durationchagne event", 1, function(){
  ...
  video.addEventListener( "durationchange", function(){
    equal( video.duration, 383, "duration is set and durationchange fired." );
    start();
  }, false);
